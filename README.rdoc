...
4. Run <tt>rake ajax:install</tt> to copy required assets into your application and public directories.  The command is safe to run multiple times and will not overwrite existing files.
